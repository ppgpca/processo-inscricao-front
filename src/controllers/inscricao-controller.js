import { isDadosPessoaisValidos } from './dados-pessoais-controller.js'
import { isDadosFormacaoValidos } from './formacao-controller.js'
import { isProjetoPesquisaValido } from './projeto-pesquisa-controller.js'
 ...
 */
export function validarEtapaAtual(activeStep, { projetoPesquisa, dadosPessoais, dadosComplementares, emailConfirmValido, todosObrigatoriosEnviados }) {
	switch (activeStep) {
		case 1:
 ...
 */
export function obterTextoBotaoProximo(saving, activeStep) {
 ...
 */
export function prepararPayloadEtapa2(cpf, idEdital, projetoPesquisa, inscricaoExistente) {
	const dadosLinha = {
 ...
 */
export function prepararPayloadEtapa3(dadosComplementares) {
	return {
		etapa: 3,
		dadosComplementares,
	}
 ...
 */
export function obterFonteDadosComplementares(inscricaoAnterior, inscricaoHistorico) {
	return (

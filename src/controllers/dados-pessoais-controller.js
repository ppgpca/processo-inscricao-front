 ...
 */
export function formatTelefone(valor) {
 ...
 */
export function formatCelular(valor) {
 ...
 */
export function sanitizeEmail(valor) {
 ...
 */
export function validarDadosPessoais(dados, emailConfirmValido) {
 ...
 */
export function isDadosPessoaisValidos(dados, emailConfirmValido) {
	const emailValido = !!dados.email && validarFormatoEmail(dados.email)
	const email2Valido = !dados.email2 || validarFormatoEmail(dados.email2)
 ...
 */
export function prepararPayloadCandidato(cpf, dados) {
	return {
		cpf,
		nome: dados.nome,
 ...
 */
export function getInitialDadosPessoais() {
	return {
		nome: '',
		dataNascimento: '',
		rg: '',
 ...
 */
export function carregarDadosPessoaisExistentes(cand) {

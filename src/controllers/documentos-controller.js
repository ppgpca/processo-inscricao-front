 ...
 */
export function obterDocumentoAtual(documentos, idTipo) {
	return documentos.find((d) => d.idTipoDocumentoEdital === idTipo && d.atual) ?? null
}

/**
 * Verifica se todos os documentos obrigatórios e ativos foram enviados
 */
export function todosObrigatoriosEnviados(tiposDocumento, documentos) {
 ...
 */
export function ordenarTiposDocumentoAtivos(tipos) {
 ...
 */
export function extrairNomeArquivoDownload(contentDisposition, fallback) {
 ...
 */
export function obterMensagemErroUpload(error) {
	return (

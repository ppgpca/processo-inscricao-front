 ...
 */
export function formatarDataFimInscricao(data: string | null | undefined): string | null {
 ...
 */
export function formatarDataInicioInscricao(data: string | null | undefined): string | null {
	return formatarData(data)
}

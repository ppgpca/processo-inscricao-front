...
function onFulfilledRequest(config: InternalAxiosRequestConfig): InternalAxiosRequestConfig {
...
axiosInstance.interceptors.response.use(onFulfilledResponse as any, handleResponseError)
